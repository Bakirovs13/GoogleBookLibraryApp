package kg.geektech.googlebooklibraryapp.adapters;
...
import kg.geektech.googlebooklibraryapp.ui.BookDetail;
...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.BookViewHolder> {
    ...
    public BookViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rv_book, parent, false);
